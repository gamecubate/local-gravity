...
ig.Entity.inject({
	...
	update: function()
	{
		...
		if (this.localGravity.mass && this.localGravity.drawnBy != ig.Entity.TYPE.NONE)
		{
			...
			for (var i=0; i<ents.length; i++)
			{
				...
				if (ent == this || ! ent.localGravity.mass || this.localGravity.drawnBy == ig.Entity.TYPE.NONE )
					continue;
				
				if (this.localGravity.drawnBy & ent.type)
					others.push(ent);
			}
