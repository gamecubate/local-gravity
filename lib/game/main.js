...
MyGame = ig.Game.extend({
	...
	generate: function(numPlanets, numSuns)
	{
		...
		for (var i=0; i<numPlanets; i++)
		{
			...
			planet.localGravity.drawnTo = ig.Entity.TYPE.A;
	...
	{
		return this.planets[0].localGravity.drawnTo == ig.Entity.TYPE.BOTH;
	},

	togglePlanetaryAttraction: function()
	{
		var newval = this.planetsAttractEachOther() ? ig.Entity.TYPE.A : ig.Entity.TYPE.BOTH ;
		_.each(this.planets, function(p){ p.localGravity.drawnTo = newval; });
	},
